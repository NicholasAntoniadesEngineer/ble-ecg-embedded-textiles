...
def plot_ecg_bokeh(an_ecg_object, channels=None):
    ...
    figures = []
    for a_channel_idx, a_channel_waveform in enumerate(channels):
        if a_channel_idx == 0:
            figures.append(bokeh.plotting.figure(width=900,
                                                 ...
                                                 title=f"{channels[a_channel_idx]}"))
        else:
            figures.append(bokeh.plotting.figure(x_range=figures[0].x_range,
                                                 ...
                                                 tools="pan, box_zoom, reset",
                                                 title=f"{channels[a_channel_idx]}"))
        figures[-1].line(shared_x_values, an_ecg_object[a_channel_waveform])
