...
SOURCEFILES_QUOTED_IF_SPACED=funcs.c nodemain.c bmi160bmm150.c base64.c sensor.c ads1293.c board_comms.c I2Clib.c SPIlib.c strain_adc.c max32664.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/funcs.o ${OBJECTDIR}/nodemain.o ${OBJECTDIR}/bmi160bmm150.o ${OBJECTDIR}/base64.o ${OBJECTDIR}/sensor.o ${OBJECTDIR}/ads1293.o ${OBJECTDIR}/board_comms.o ${OBJECTDIR}/I2Clib.o ${OBJECTDIR}/SPIlib.o ${OBJECTDIR}/strain_adc.o ${OBJECTDIR}/max32664.o
POSSIBLE_DEPFILES=${OBJECTDIR}/funcs.o.d ${OBJECTDIR}/nodemain.o.d ${OBJECTDIR}/bmi160bmm150.o.d ${OBJECTDIR}/base64.o.d ${OBJECTDIR}/sensor.o.d ${OBJECTDIR}/ads1293.o.d ${OBJECTDIR}/board_comms.o.d ${OBJECTDIR}/I2Clib.o.d ${OBJECTDIR}/SPIlib.o.d ${OBJECTDIR}/strain_adc.o.d ${OBJECTDIR}/max32664.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/funcs.o ${OBJECTDIR}/nodemain.o ${OBJECTDIR}/bmi160bmm150.o ${OBJECTDIR}/base64.o ${OBJECTDIR}/sensor.o ${OBJECTDIR}/ads1293.o ${OBJECTDIR}/board_comms.o ${OBJECTDIR}/I2Clib.o ${OBJECTDIR}/SPIlib.o ${OBJECTDIR}/strain_adc.o ${OBJECTDIR}/max32664.o

# Source Files
SOURCEFILES=funcs.c nodemain.c bmi160bmm150.c base64.c sensor.c ads1293.c board_comms.c I2Clib.c SPIlib.c strain_adc.c max32664.c
...
${OBJECTDIR}/strain_adc.o: strain_adc.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/strain_adc.o.d 
	@${RM} ${OBJECTDIR}/strain_adc.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  strain_adc.c  -o ${OBJECTDIR}/strain_adc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/strain_adc.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O1 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	@${FIXDEPS} "${OBJECTDIR}/strain_adc.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/max32664.o: max32664.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/max32664.o.d 
	@${RM} ${OBJECTDIR}/max32664.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  max32664.c  -o ${OBJECTDIR}/max32664.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/max32664.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O1 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	@${FIXDEPS} "${OBJECTDIR}/max32664.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/strain_adc.o: strain_adc.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/strain_adc.o.d 
	@${RM} ${OBJECTDIR}/strain_adc.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  strain_adc.c  -o ${OBJECTDIR}/strain_adc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/strain_adc.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O1 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	@${FIXDEPS} "${OBJECTDIR}/strain_adc.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/max32664.o: max32664.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/max32664.o.d 
	@${RM} ${OBJECTDIR}/max32664.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  max32664.c  -o ${OBJECTDIR}/max32664.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/max32664.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O1 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	@${FIXDEPS} "${OBJECTDIR}/max32664.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
